<template>
<section class="flex items-center justify-center  h-full bg-red-300">
	...
	<!-- Component Start -->
	<div class="flex flex-col items-center w-full h-full overflow-hidden text-gray-400 bg-gray-100 rounded">
		...
		<div class="w-full px-1">
			<div class="flex flex-col items-center w-full bg-gray-100 ">
              ...
              <input
                type="text"
                class=" block w-full pl-10 pr-12 py-1 sm:text-sm border-gray-300 rounded-md"
                placeholder="search"
              />
            </div>
